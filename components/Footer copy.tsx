...
const Footer = () => {
  return (
    <footer id="footer" className="h-full bg-black text-white text-center max-h-full mt-auto">
      <div className="px-4 pb-6 sm:px-6 lg:px-8 pt-10">
        <div className="flex flex-col">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
            ...
            <div className="grid grid-cols-1 gap-3 md:gap-6 lg:gap-10 md:grid-cols-2 xl:grid-cols-4 lg:col-span-3">
              <div className="flex flex-col items-center lg:items-start gap-2">
                <p className="font-bold text-base md:text-lg lg:text-xl uppercase text-start">Consortium&apos;23</p>
                <p className="text-center lg:text-left text-[12px] md:text-sm lg:text-base lg:mt-4 w-1/2 lg:w-full">Consortium, the Annual Entrepreneurship Summit and Management Fest of VNIT, Nagpur</p>
              </div>
              <div className="flex flex-col items-center lg:items-start gap-2">
                <p className="font-bold text-base md:text-lg lg:text-xl uppercase text-start">Quick Links</p>
              ...
              <div className="flex flex-col items-center lg:items-start gap-2">
                <p className="font-bold text-base md:text-lg lg:text-xl uppercase text-start">Contact Us</p>
                <nav className="flex flex-col space-y-1 lg:space-y-2 lg:mt-4 text-start text-[11px] md:text-sm xl:text-base text-white">
                  <a className="hover:opacity-75" target="_blank" rel="noreferrer" href="mailto:team_ecell@vnit.ac.in">
                    For Queries & Communications: <br />
                    <strong>
                      team_ecell@vnit.ac.in
                    </strong>
                  </a>
              ...
              <div className="flex flex-col items-center lg:items-start gap-2">
                <p className="font-bold text-base md:text-lg lg:text-xl uppercase">Follow Us</p>
                <nav className="flex flex-col lg:mt-4 space-y-2 lg:space-y-3 items-start text-sm text-white">
                  <Link
                    ...
                    rel="noreferrer"
                  >
                    <svg className="w-5 h-5 lg:h-7 lg:w-7" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="text-[11px] md:text-sm lg:text-lg">Instagram</span>
                  </Link>
                  <Link
                    className="hover:opacity-75 flex justify-center gap-2 lg:gap-4"
                  ...
                  >
                    ...
                    <span className="text-[11px] md:text-sm lg:text-lg">LinkedIn</span>
                  </Link>
                  <Link
                    className="hover:opacity-75 flex justify-center gap-2 lg:gap-4"
                  ...
                  >
                    ...
                    <span className="text-[11px] md:text-sm lg:text-lg">Facebook</span>
                  </Link>
                  <Link
                    className="hover:opacity-75 flex justify-center gap-2 lg:gap-4"
                  ...
                  >
                    ...
                    <span className="text-[11px] md:text-sm lg:text-lg">YouTube</span>
                  </Link>
                  <Link
                    className="hover:opacity-75 flex justify-center gap-2 lg:gap-4"
                  ...
                  >
                    ...
                    <span className="text-[11px] md:text-sm lg:text-lg">Twitter</span>
                  </Link>
                </nav>
              </div>
            </div>
          ...
          <div className="flex flex-col md:pl-16 justify-center items-center pt-4 md:pt-10">
            <p className="font-bold text-base md:text-lg lg:text-xl uppercase">Visit us</p>
            <p className="text-center text-[11px] md:text-sm lg:text-base lg:mt-4 w-full lg:w-1/3">E-Cell office, 1st Floor VNIT Canteen, Visvesvaraya National Institute Of Technology, South Ambazari Road, Abhyankar Nagar, Nagpur-440010</p>
            <p className="mt-3 lg:mt-8 text-[11px] md:text-lg lg:text-2xl text-white">Copyright:
